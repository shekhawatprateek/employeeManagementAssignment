...
const EmployeeForm = ({ employee = {}, onSave, isEdit = false, onCancel }) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios[method](url, formData)
      .then(() => {
        ...
        setFormData({ name: "", position: "", department: "", email: "", phoneNumber: "" }); // Reset form
        onSave(); // 🔥 Trigger fetch after saving
      })
